...
export default function Deal() {
  return (
    <>
    <h1 className="text-3xl text-center font-prata leading-[50px]">Special Deal On Properties</h1>
    ...
    <div className="p-10 px-28 ">
        ...
        <p className="text-gray-500 text-sm mb-5">Just steps away from QM2 express bus to Manhattan and locals buses; only minutes from the LIRR. Walkings distances to Bay Terrace Shopping Centers, Baybridge Common Shopping Center, pool clubs, movie theaters and tennis courts.</p>
